...
import {
  staggerNormal, revealNormal, revealSubtle, stickyBar,
  dur, ease,
...
// Which reader index gets the "recommended" highlight (first Master)
        ...
        <motion.div
          ...
          {question.category && (
            <p className="mt-1.5 font-sans text-sm" style={{ color: 'var(--text-muted)' }}>
              For questions about{' '}
              <span style={{ color: 'var(--text-secondary)' }} className="capitalize">{question.category}</span>
            </p>
          )}
        </motion.div>
      ...
      <AnimatePresence>
        {selectedReader.id && (
          <motion.div
            ...
            <div className="glass border-t safe-bottom px-6 py-4"
    ...
    <motion.div
      ...
      {isRecommended && !isSelected && (
        <div className="absolute right-0 top-0">
          <div className="rounded-bl-lg px-3 py-1"
            style={{ background: 'rgba(196,150,74,0.1)', borderBottom: '1px solid rgba(196,150,74,0.2)', borderLeft: '1px solid rgba(196,150,74,0.2)' }}>
            <p className="label-overline" style={{ color: 'var(--gold)', fontSize: '0.6rem' }}>Recommended</p>
          </div>
        </div>
      )}
      ...
      <div className="p-5">
        ...
        <div className="flex gap-4">
          {/* Avatar — initial with tier-colored bg */}
          <div className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-xl font-serif text-xl font-light transition-colors"
        ...
        <div className="mt-4 pl-[4.5rem]">
          <p className={cn(
            'font-sans text-sm leading-relaxed transition-all',
            ...
            <motion.div
              ...
              <div className="rounded-lg px-4 py-2.5 flex items-center gap-2"
                ...
                <motion.span
                  ...
                  style={{ color: 'var(--gold)' }} className="text-xs">
                  ✓
                </motion.span>
