...
const FORMATS = [
  {
    ...
    description: 'Ваш читатель медитирует над вашим вопросом, тянет карты и составляет развёрнутый письменный ответ.',
  ...
  },
  {
    ...
    description: 'Разговор с читателем в реальном времени. Задавайте уточняющие вопросы и исследуйте темы по мере их возникновения.',
